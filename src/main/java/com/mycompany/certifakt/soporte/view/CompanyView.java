...
public class CompanyView extends javax.swing.JFrame {
    ...
    public CompanyView(CompanyDto company) {
        ...
        cmbOse.setSelectedItem(
                company.getOseId() == 10 ? "Certicom" : 
                company.getOseId() == 12 ? "Blizlink" : 
                company.getOseId() == null ? "-" : "-"
        );
    ...
    private void initComponents() {
        ...
        jPanel2.add(txtRuc, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 50, 280, -1));

        jLabel9.setText("Telefono:");
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 100, 150, -1));
        jPanel2.add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 100, 260, -1));

        jLabel3.setText("Nombre comercial:");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 150, -1));
        jPanel2.add(txtNombreComercial, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 100, 280, -1));

        jLabel10.setText("Ose:");
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 150, 150, -1));

        jPanel2.add(cmbOse, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 150, 260, -1));

        jLabel4.setText("Razón social:");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 140, -1));
        jPanel2.add(txtRazonSocial, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 150, 280, -1));

        lblVerGuia.setText("Ver guia:");
        jPanel2.add(lblVerGuia, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 200, 150, -1));
        jPanel2.add(ckbVerGuia, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 200, -1, -1));

        jLabel5.setText("Direccion:");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 140, -1));
        jPanel2.add(txtDireccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 200, 280, -1));

        lblVerOtroComprobante.setText("Ver otro comprobante:");
        jPanel2.add(lblVerOtroComprobante, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 250, 160, -1));
        jPanel2.add(ckbVerOtroComprobante, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 250, -1, -1));

        jLabel6.setText("Correo:");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 140, -1));
        jPanel2.add(txtCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 250, 280, -1));

        lblVerCotizacion.setText("Ver cotizacion:");
        jPanel2.add(lblVerCotizacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 300, 160, -1));
        jPanel2.add(ckbVerCotizacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 300, -1, -1));
        ...
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 50, 160, -1));
        jPanel2.add(ckbEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 50, -1, -1));
        ...
        jPanel2.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 83, 950, 10));
        jPanel2.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 130, 950, 10));
        jPanel2.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 180, 950, 10));
        jPanel2.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 230, 950, 10));
        jPanel2.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, 950, 10));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 950, 330));
        ...
        jPanel1.add(btnCerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 20, -1, 30));
        ...
        jPanel1.add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 430, -1, 30));
